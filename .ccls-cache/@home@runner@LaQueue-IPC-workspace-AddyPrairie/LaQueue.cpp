...
int main() {
   ...
   * *(*start_routine)(void*), void *arg); pthread_t *thread: location for
   * system to put information about the thread when created. const
   * pthread_attr_t *attr: Attributes passwd to system describing the requested
   * thread configuration. void *(*start_routine)(void*):  The routine within
   * the thread to begin execution void *arg: The arguments passed into the
   * thread, essentially the argc, argv of 'main(argc, argv)'
   * */
